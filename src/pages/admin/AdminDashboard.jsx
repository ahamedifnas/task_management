...
import {
  HiUser, HiFolderOpen, HiClock, HiCheckCircle, HiCog6Tooth, HiChartBarSquare,
...
export default function AdminDashboard() {
  ...
  const quickLinks = [
    { to: '/admin/employees', label: 'Manage Employees', desc: 'Add, edit or deactivate staff', icon: HiUser },
    { to: '/admin/projects', label: 'Manage Projects', desc: 'Configure client projects', icon: HiFolderOpen },
    { to: '/admin/ot-policy', label: 'OT Policy', desc: 'Set overtime multipliers and rules', icon: HiCog6Tooth },
    { to: '/admin/reports', label: 'Monthly Reports', desc: 'Generate and export payroll data', icon: HiChartBarSquare },
  ]
